...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoFooter = __webpack_require__(4);
	...
	var TodoApp = (function (_super) {
	    ...
	    function TodoApp() {
	        ...
	        this.newFieldCallback = function (newField) {
	            _this.newField = newField ? newField.getDOMNode() : null;
	        };
	        this.state = {
	    ...
	    TodoApp.prototype.componentDidMount = function () {
	        ...
	        var router = Router({
	            '/': function () { return _this.setState({ nowShowing: routes.ALL_TODOS }); },
	            '/active': function () { return _this.setState({ nowShowing: routes.ACTIVE_TODOS }); },
	            '/completed': function () { return _this.setState({ nowShowing: routes.COMPLETED_TODOS }); }
	        });
	        router.init('/');
	    };
	    ...
	    TodoApp.prototype.render = function () {
	        ...
	        var todoItems = shownTodos.map(function (todo) { return React.createElement(
	            TodoItem,
	            {
	                key: todo.id,
	                todo: todo,
	                onToggle: function () { return _this.toggle(todo); },
	                onDestroy: function () { return _this.destroy(todo); },
	                onEdit: function (callback) { return _this.edit(todo, callback); },
	                editing: _this.state.editing === todo.id,
	                onSave: function (text) { return _this.save(todo, text); },
	                onCancel: function () { return _this.cancel(); }
	            }
	        ); });
	        ...
	        if (activeTodoCount || completedCount) {
	            footer = React.createElement(
	                TodoFooter,
	                {
	                    ...
	                    onClearCompleted: function () { return _this.clearCompleted(); }
	                }
	            );
	        }
	        if (todos.length) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoModel = (function () {
	    ...
	    TodoModel.prototype.inform = function () {
	        ...
	        this.onChanges.forEach(function (callback) { return callback(); });
	    };
	    ...
	    TodoModel.prototype.destroy = function (todo) {
	        this.todos = this.todos.filter(function (candidate) { return candidate !== todo; });
	        this.inform();
	    };
	    TodoModel.prototype.save = function (todoToSave, text) {
	        this.todos = this.todos.map(function (todo) { return todo !== todoToSave ? todo : Utils.extend({}, todo, { title: text }); });
	        this.inform();
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItem = (function (_super) {
	    ...
	    function TodoItem() {
	        ...
	        this.editFieldCallback = function (editField) {
	            _this.editField = editField ? editField.getDOMNode() : null;
	        };
	    ...
	    TodoItem.prototype.render = function () {
	        var className = this.props.editing ? 'editing' : true ? 'complete' : '';
	        return (React.createElement(
	            "li",
	            {
	                className: className
	            ...
	            React.createElement(
	                ...
	                React.createElement("label", { onDoubleClick: this.handleEdit }, this.props.todo.title, " " ),
